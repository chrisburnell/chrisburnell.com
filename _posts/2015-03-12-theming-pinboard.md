...
{% include inline/heading.html title='The First Step' %}
...
{% include inline/heading.html title='<code>injection"); DROP TABLE Bookmarks;--</code>' id='injection' %}
...
{% include inline/heading.html title='Good old Brass Tacks' id='brass-tacks' %}
...
{% include inline/heading.html title='Challenges' %}
...
{% include inline/heading.html title='Changes' %}
...
{% include inline/heading.html title='Conclusion' %}
