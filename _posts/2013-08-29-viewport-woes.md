...
{% include heading.html id="times-are-changing" title="The times, they are a-changing" %}
...
{% include heading.html id="responsive-magic" title="So what makes all this responsive magic work?" %}
...
{% include heading.html id="plain-and-simple" title="Just give it to me plain and simple" %}
