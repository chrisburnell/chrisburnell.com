...
{% include inline/heading.html title='The times, they are a-changing' id='times-are-changing' %}
...
{% include inline/heading.html title='So what makes all this responsive magic work?' id='responsive-magic' %}
...
{% include inline/heading.html title='Just give it to me plain and simple' id='plain-and-simple' %}
