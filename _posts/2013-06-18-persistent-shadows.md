...
{% include heading.html title='We’ve hit a snag!' id='hit-a-snag' %}
...
{% include codepen.html slug="mglHp" height="425" %}


{% include heading.html title='How does that work?' %}
...
{% include heading.html title='What else is there?' id='what-else' %}
...
{% include heading.html title='A little something-something extra, just for you' id='something-extra' %}
...
{% include codepen.html slug="arouk" height="150" %}
...
{% include codepen.html slug="DoJKw" height="200" %}
