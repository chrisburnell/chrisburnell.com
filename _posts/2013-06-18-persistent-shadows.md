...
{% include inline/codepen.html slug="kJcGE" theme="tabfree" height="220" %}
...
{% include inline/heading.html title='We’ve hit a snag!' id='hit-a-snag' %}
...
{% include inline/codepen.html slug="mglHp" height="425" %}


{% include inline/heading.html title='How does that work?' %}
...
{% include inline/heading.html title='What else is there?' id='what-else' %}
...
{% include inline/heading.html title='A little something-something extra, just for you' id='something-extra' %}
...
{% include inline/codepen.html slug="arouk" height="150" %}
...
{% include inline/codepen.html slug="DoJKw" height="200" %}
