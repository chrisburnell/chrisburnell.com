...
{% include inline/heading.html title='Psychedelic Slice' %}

Hover the slice to see how this one works.

{% include inline/codepen.html slug="apogK" height="350" %}
...
{% include inline/heading.html title='Zoomy Anchor Thing' %}

This pen was inspired by an neat effect I saw on [Square](https://squareup.com#verticals).

{% include inline/codepen.html slug="lcEvB" height="350" %}
...
{% include inline/heading.html title='Modal Container without JS' %}
...
{% include inline/codepen.html slug="scyKF" height="350" %}
...
{% include inline/heading.html title='Slip-n-slide Modal' %}
...
{% include inline/codepen.html slug="sDBJk" height="630" %}


{% include inline/heading.html title='Simple CSS Checkbox Revisited' %}
...
{% include inline/codepen.html slug="arouk" height="250" %}

And the revisited version:

{% include inline/codepen.html slug="Cbiun" height="250" %}
...
{% include inline/heading.html title='Over to you' %}
