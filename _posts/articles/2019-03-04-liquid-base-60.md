...
Off the back of the [Tantek Çelik’s](http://tantek.com/) enlighting and superb work on *Whistle*[^1] and *NewBase60*[^2], I yearned for a way to generate short-URLs for each of my post categories, and figured out a way, albeit a bit over-complicated, using vanilla Jekyll/Liquid.
...
<figure>
    <samp class="beta">repc.co/<strong style="color: var(--color-raven);">n</strong><strong style="color: var(--color-canada);">4wN</strong><strong style="color: var(--color-liquid);">1</strong> <a href="https://repc.co/n4wN1">→</a></samp>
</figure>
...
0. <samp class="strong" style="color: var(--color-canada);">4wN</samp> — **[Sexagesimal](http://en.wikipedia.org/wiki/Sexagesimal) [Epoch](https://en.wikipedia.org/wiki/Unix_time) Days** *(required, 3 characters)* <a href="#sexagesimal-epoch-days">↩</a>
...
{% include_cached content/heading.liquid title='Category' %}
...
{% include_cached content/heading.liquid title='Sexagesimal Epoch Days' %}
...
{% include_cached content/heading.liquid title='Post Number for the Day' %}
...
{% include content/heading.liquid title='Presenting…' %}
...
[^1]: [Whistle](http://tantek.pbworks.com/w/page/21743973/Whistle)
[^2]: [NewBase60](http://tantek.pbworks.com/w/page/19402946/NewBase60)
[^3]: [Sexagesimal - Wikipedia](https://en.wikipedia.org/wiki/Sexagesimal)
