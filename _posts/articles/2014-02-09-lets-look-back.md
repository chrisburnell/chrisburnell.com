...
7. [My Sass files]({{ site.author.urls.github_repo }}/tree/master/src/scss "Sass files for chrisburnell.com")
8. [My gulpfile configuration]({{ site.author.urls.gist }}/87346fa1e8e8538ee7ce "My gulpfile configuration")
...
You can see the raw, uncompiled SCSS files on GitHub [here]({{ site.author.urls.github_repo }}/tree/master/css "SCSS files for chrisburnell.com"), and the README file of the repository [here]({{ site.author.urls.github_repo }}).

As always, please let me know if you have any comments, suggestions, or bug-fixes [in the comments below](#comments) or [create an Issue on Github]({{ site.author.urls.github_repo }}/issues)!
