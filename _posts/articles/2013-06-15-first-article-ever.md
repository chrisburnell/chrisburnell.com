...
{% include_cached content/heading.liquid title='More than meets the eye' %}
...
{% include_cached content/heading.liquid title='What’s new in this iteration?' id='whats-new' %}
...
{% include_cached content/heading.liquid title='What is Jekyll?' %}
...
{% include_cached content/heading.liquid title='Better, Faster, Stronger' %}
...
{% include_cached content/heading.liquid title='Let’s get down to brass tacks' id='brass-tacks' %}
...
{% include_cached content/heading.liquid title='Major props' %}
...
- [Jake Archibald (Google)](https://www.jakearchibald.com/ "Jake Archibald (Google)")
...
- [Christian Heilmann (Mozilla)](https://www.christianheilmann.com/ "Christian Heilmann (Mozilla)")
