...
{% include_cached content/heading.liquid title='The times, they are a-changing' id='times-are-changing' %}
...
{% include_cached content/heading.liquid title='So what makes all this responsive magic work?' id='responsive-magic' %}
...
{% include_cached content/heading.liquid title='Just give it to me plain and simple' id='plain-and-simple' %}
