...
{% include_cached content/heading.liquid title='Psychedelic Slice' %}

Hover the slice to see how this one works.

{% include content/codepen.liquid slug='apogK' height='350' %}
...
{% include_cached content/heading.liquid title='Jazzy CSS Checkbox Revisited' %}
...
{% include content/codepen.liquid slug='arouk' height='250' %}
