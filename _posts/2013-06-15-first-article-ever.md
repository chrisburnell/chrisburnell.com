...
{% include inline/heading.html title='More than meets the eye' %}
...
{% include inline/heading.html title='What’s new in this iteration?' id='whats-new' %}
...
{% include inline/heading.html title='What is Jekyll?' %}
...
{% include inline/heading.html title='Better, Faster, Stronger' %}
...
<aside><p>Again, if you have any suggestions as far as the source code or post content goes, please fork <a href="{{ site.url_github }}">the GitHub repository</a> and send me a push request with your changes!</p></aside>
...
{% include inline/heading.html title='Let’s get down to brass tacks' id='brass-tacks' %}
...
{% include inline/heading.html title='Major props' %}
