...
{% include heading.html title='More than meets the eye' %}
...
{% include heading.html title='What’s new in this iteration?' id='whats-new' %}
...
{% include heading.html title='What is Jekyll?' %}
...
{% include heading.html title='Better, Faster, Stronger' %}
...
{% include heading.html title='Let’s get down to brass tacks' id='brass-tacks' %}
...
{% include heading.html title='Major props' %}
...
{% include heading.html title='And that’s basically it!' id='thats-it' %}
