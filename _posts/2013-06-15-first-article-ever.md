...
<aside><a href="http://browser.londonwebstandards.org/gallery_2013.php"><img src="{{ site.url }}/images/articles/sotb-2013.png" class="banner  rounded"></a><p class="italic  gray">Image courtesy of [London Web Standards](http://browser.londonwebstandards.org/).</p></aside>
