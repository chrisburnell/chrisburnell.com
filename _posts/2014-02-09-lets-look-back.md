...
{% include inline/heading.html title='In comes Sass' %}
...
{% include inline/heading.html title='I don’t want to do anything, anymore!' id='i-dont-want-to-do-anything' %}
...
{% include inline/heading.html title='There must be a better way!' id='a-better-way' %}
...
{% include inline/heading.html title='Let’s see what gulp does for me' id='what-gulp-does-for-me' %}
...
{% include inline/heading.html title='Good old brass tacks' %}
...
{% include inline/heading.html title='You’ll notice a few major changes' id='a-few-major-changes' %}
...
{% include inline/heading.html title='Useful Links' %}
...
7. [My Sass files]({{ site.url_repository }}/tree/master/css "Sass files for chrisburnell.com")
...
{% include inline/heading.html title='Wrapping it up' %}
...
{% include inline/heading.html title='So that’s what’s up' id='thats-whats-up' %}
...
You can see the raw, uncompiled SCSS files on GitHub [here]({{ site.url_repository }}/tree/master/css "SCSS files for chrisburnell.com"), and the README file of the repository [here]({{ site.url_repository }}).

As always, please let me know if you have any comments, suggestions, or bug-fixes [in the comments below](#comments) or [create an Issue on Github]({{ site.url_repository }}/issues)!
