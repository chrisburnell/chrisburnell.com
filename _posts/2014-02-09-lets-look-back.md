...
<aside><p>I also wrote about <a rel="external" href="http://browser.londonwebstandards.org" title="State of the Browser 2013">State of the Browser 2013</a> in <a href="{% post_url 2013-06-15-first-article-ever %}" title="First Ever Article">my first article</a>.</p></aside>
...
{% include_cached content/heading.html title='There must be a better way!' id='a-better-way' %}

<figure>
    {% include_cached content/img.html src='/images/content/good-news-everyone.png' alt='Good news everyone!' %}
...
{% include_cached content/heading.html title='Let’s see what gulp does for me' id='what-gulp-does-for-me' %}
...
{% include_cached content/heading.html title='Good old brass tacks' %}
...
<figure>
    {% include_cached content/img.html src='/images/content/welldone.gif' alt='Just look at it... Beautiful.' %}
    <figcaption>Success.</figcaption>
</figure>


{% include_cached content/heading.html title='You’ll notice a few major changes' id='a-few-major-changes' %}
...
{% include_cached content/heading.html title='Useful Links' %}
...
{% include_cached content/heading.html title='Wrapping it up' %}
...
{% include_cached content/heading.html title='So that’s what’s up' id='thats-whats-up' %}
