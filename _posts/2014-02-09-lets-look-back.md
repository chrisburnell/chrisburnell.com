...
7. [My Sass files]({{ site.urls.repository }}/tree/master/css "Sass files for chrisburnell.com")
...
You can see the raw, uncompiled SCSS files on GitHub [here]({{ site.urls.repository }}/tree/master/css "SCSS files for chrisburnell.com"), and the README file of the repository [here]({{ site.urls.repository }}).

As always, please let me know if you have any comments, suggestions, or bug-fixes [in the comments below](#comments) or [create an Issue on Github]({{ site.urls.repository }}/issues)!
