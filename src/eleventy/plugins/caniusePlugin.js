	...
	eleventyConfig.addNunjucksShortcode("caniuse", (feature) => {
		...
		return minifier.minify(
			...
			<div class="box">
				...
				<p class="small">Browser support data comes from <a href="https://caniuse.com/#feat=${feature}">caniuse.com</a> and is up-to-date as of ${DateTime.fromJSDate(new Date(global.now)).toFormat("dd LLLL yyyy")}.</p>
			</div>
		`,
			{
