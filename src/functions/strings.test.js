...
describe("Functions: Strings", () => {
	it("capitalize() returns a capitalized string", () => {
		expect(strings.capitalize("lorem ipsum")).toBe("Lorem Ipsum");
	});

	it("stripHTML() returns a string with HTML tags stripped", () => {
		expect(strings.stripHTML("<p>lorem ipsum</p>")).toBe("lorem ipsum");
	});

	it("numberNthFormat() returns a sequence-based English variant of a number", () => {
