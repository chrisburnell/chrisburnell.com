...
eleventyComputed:
  ...
  description: "Memorable and maintainable design tokens in SCSS.<br>There are {{ github.bowhead['stargazers_count'] }} star-gazers <a href='https://github.com/chrisburnell/bowhead'>on GitHub</a> and it was downloaded {{ npm.bowhead['downloads'] }} times in the last month <a href='https://www.npmjs.com/package/@chrisburnell/bowhead'>on npm</a>."
