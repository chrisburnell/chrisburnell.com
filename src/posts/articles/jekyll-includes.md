...
description: I've been using Jekyll for over three years, and built a series of useful reusable components to streamline my templating and authoring processes.
# tags:
#   - jekyll
#   - liquid
---
...
<{{ heading_type }} id="{{ heading_id }}">
    {{ include.title }}
    <!-- 4 -->
    {% include content/fragment_anchor.liquid id=heading_id %}
</{{ heading_type }}>
{% endraw %}
```
