...
7. [My Sass files]({{ author.urls.github_repo }}/tree/main/src/scss "Sass files for chrisburnell.com")
...
You can see the raw, uncompiled SCSS files on GitHub [here]({{ author.urls.github_repo }}/tree/main/css "SCSS files for chrisburnell.com"), and the README file of the repository [here]({{ author.urls.github_repo }}).
