...
<figure>
    <iframe src="https://player.vimeo.com/video/164122074?color={{ palette | arrayKeyEquals("name", "Raven") | first | keyValue("hex") }}&title=0&byline=0&portrait=0" allowfullscreen></iframe>
    <figcaption>
