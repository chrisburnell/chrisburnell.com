...
This enhancement will work no matter to whom I reply on *Twitter*. But <q>dletorey</q> happens to be a very good friend of mine, and I reply to him often.
...
Can I pull the name of the User to whom I am responding from the *Twitter* API? Unfortunately, when I POST a new Tweet, the response from *Twitter’s* API does not include the target’s name, so pulling this data out cannot simply be tacked onto the end of the *Micropub* work. This means that a second request to the *Twitter* API would have to be made to pull out the name of the user.
...
- *Name* of the *User* to whom I am responding?
